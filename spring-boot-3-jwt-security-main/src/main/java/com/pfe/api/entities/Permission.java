...
//    MANAGER_DELETE("management:delete"),
    ...
    DEPARTEMENT_UPDATE("departementchef:update"),
    DEPARTEMENT_CREATE("departement:create"),
    DEPARTEMENT_DELETE("departement:delete"),
    DEPARTEMENT_CHEF_READ("chefdepartement:read"),
    DEPARTEMENT_CHEF_UPDATE("chefdepartementchef:update"),
    DEPARTEMENT_CHEF_CREATE("chefdepartement:create"),
    DEPARTEMENT_CHEF_DELETE("chefdepartement:delete"),
